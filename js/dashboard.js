...
// Modo de demonstração (quando o servidor não está disponível)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Verificar se deve usar modo de demonstração
    if (DEMO_MODE || !navigator.onLine) {
        console.warn('Usando modo de demonstração');
        updateCounters(DEMO_DATA.alunos, DEMO_DATA.professores, DEMO_DATA.cursos);
        updateCharts(DEMO_DATA);
    } else {
        loadDashboardData();
    }
});
